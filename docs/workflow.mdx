...
<div class="github-toc">
  ...
  <ul>
    ...
    <li><a href="#workflow-triggers">Workflow Triggers</a>
    </li>
    <li><a href="#workflow-structure-jobs-and-dependencies">Workflow Structure: Jobs and Dependencies</a></li>
    <li><a href="#workflow-execution-details">Workflow Execution Details</a>      
    </li>
    <li><a href="#advanced-workflow-features">Advanced Workflow Features</a>
    </li>
  </ul>
</div>
